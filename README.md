...
For a demonstration of the project, you can download the video [!here]([https://www.python.org/downloads/](https://onlinelibrary.wiley.com/action/downloadSupplement?doi=10.1002%2Fadfm.202104628&file=adfm202104628-sup-0002-VideoS1.avi)) Please note that this video is used solely for illustrative purposes and does not contain the actual code or proprietary content of the project. If you have any questions or would like to discuss the project further, feel free to reach out.
